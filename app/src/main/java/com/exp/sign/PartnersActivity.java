            ...
            listDialog.setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if(which == 0) {
                        ...
                        userBmobQuery.addWhereEqualTo("username", (String) SPUtil.get(PartnersActivity.this,"username", ""));
                        userBmobQuery.findObjects(new FindListener<BmobUser>() {
                            @Override
                            public void done(List<BmobUser> list, BmobException e) {
                                if(e == null) {
                                    if(list != null && !list.isEmpty() && !TextUtils.isEmpty(list.get(0).getMatch())) {
                                ...
                                if(e != null) {
                                    ...
                                    Toast.makeText(PartnersActivity.this, "Please complete the exercises information first", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    } else {
